...
// %%%%%%%%%%%%%%%%%%%%%%%%%% URL changer %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  goToItemUrl: util.backgroundFunction("Page.goToItemUrl",
  ...
  goToAutoFillPending: util.backgroundFunction("Page.goToAutoFillPending",
    () => goToAutoFillPending),
...
// %%%%%%%%%%%%%%%%%%%%%%%%%% Form filler %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  fillActiveElement: util.contentFunction("Page.fillActiveElement",
  ...
  fillInputs: util.contentFunction("Page.fillInputs",
...
// %%%%%%%%%%%%%%%%%%%%%%% Form submitter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  submit: util.contentFunction("Page.submit", function (form) {
  ...
  safeSubmit: util.backgroundFunction("Page.safeSubmit", function (sender) {
    let tab = sender.tab;
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%% Miscellaneous %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  getTabContainer: util.backgroundFunction("Page.getTabContainer", function (sender) {
